 ...
 * 设备上报平台执行器
 */
public class ThingPostMqttExecutor  {
...
//    private final Type tokenType = new TypeToken<AlinkReply<Map<String, String>>>() {
//    }.getType();
//
//    public ThingPostMqttExecutor(ThingImpl thing, ThingExecutor executor, ThingMessenger messenger) {
//        this.thing = thing;
...
//
//        // 解析alink应答数据
//        final AlinkReply<Map<String, String>> aReply = gson.fromJson(message, tokenType);
//
//        // 请求ID
...
//        if (null == replyP) {
//            logger.warn("{}/post reply received, but promised is not found, token={};topic={};",
//                    thing,
//                    token,
//                    mqttTopic
//            );
